...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "No Name Set Yet, Check @TheAlphabotz"
...
async def _(event):
    ...
    file_ext_ns_ion = "@TheAlphabotz_Sticker.png"
    ...
    if is_a_s:
        ...
        if userid == 1111847352:
            packshortname = "TheAlphaBotz_animated"
        else:
